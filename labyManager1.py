...
class LabyManager:
	...
	def loadLABY(self):
		with open('./data/laby02.txt') as file:
	...
	def displayLaby(self, shadow):
		wall = pygame.image.load('./data/wallm.png').convert_alpha()
		
		mac = pygame.image.load('./data/macgyver1.png').convert()
		mac_b = pygame.transform.scale(mac, (30, 30))

		needle = pygame.image.load('./data/needle1.png').convert_alpha()
		...
		tube = pygame.image.load('./data/tube.png').convert_alpha()
		tube_b = pygame.transform.scale(tube, (30, 30))

		guard = pygame.image.load('./data/guard.png').convert_alpha()
	
		space = pygame.image.load('./data/space.png').convert_alpha()
